...
let JwtstrategyService = class JwtstrategyService extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    ...
    validate(payload) {
        passport_jwt_1.ExtractJwt.fromAuthHeaderWithScheme('jwt');
        return this.helper.validateUser(payload);
    }
};
JwtstrategyService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [authhelper_service_1.AuthhelperService, config_1.ConfigService])
], JwtstrategyService);
exports.JwtstrategyService = JwtstrategyService;
//# sourceMappingURL=jwtstrategy.service.js.map